...
function App() {
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section
        id="home"
        className="min-h-screen flex items-center bg-gradient-to-br from-amber-50 to-white pt-20"
      >
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                <span className="block">Juriste | Formaliste</span>
                <span className="text-amber-600">Senior</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8">
                Création, modification et finalisation de sociétés
              </p>
              <p className="text-gray-700 mb-8 max-w-lg">
                Experte en formalités juridiques avec plus de 10 ans
                d'expérience. Je simplifie vos démarches administratives de A à
                Z.
              </p>
              <button
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1473186505569-9c61870c11f9?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Bureau professionnel"
                  className="rounded-lg shadow-lg"
                />
                <div className="absolute -bottom-6 -right-6 bg-white p-4 shadow-lg rounded-lg">
                  <div className="text-amber-600 font-bold text-xl">10+</div>
            ...
            <div className="md:w-1/2 md:pl-12">
              <h3 className="text-2xl font-bold mb-6">
                Formaliste Senior avec plus de 10 ans d'expérience
              </h3>
              <p className="text-gray-700 mb-6">
                Spécialisée dans la création, la modification et la finalisation
                de sociétés. Pragmatique, rigoureuse et orientée client, je
                simplifie vos démarches administratives de A à Z.
              </p>
              <p className="text-gray-700 mb-8">
                Mon expertise couvre l'ensemble des formalités juridiques
                nécessaires à la vie de votre entreprise, de l'immatriculation à
                la dissolution, en passant par toutes les modifications
                statutaires.
              </p>
            ...
            <div className="space-y-12">
                ...
                <div className="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <h4 className="font-medium mb-4">
                      Chambre de Commerce & d'Industrie, Évry
                    </h4>
                    <ul className="text-gray-700 space-y-2">
                      <li>
                        Accompagnement des clients pour la constitution de
                        dossiers de formalités juridiques
                      </li>
                      <li>
                        Conseil sur les obligations légales et réglementaires
                      </li>
                      <li>
                        Coordination avec les organismes (CCI, Urssaf, Insee,
                        Chambre des Métiers)
                      </li>
                      <li>
                        Gestion des formalités du Registre du Commerce et des
                        Sociétés (RCS)
                      </li>
                      <li>
                        Délivrance de clés ChamberSign pour la signature
                        électronique
                      </li>
                      <li>
                        Génération de plus de 60 k€/an et transformation du
                        service CFE
                      </li>
                    </ul>
                  </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-xl font-bold text-amber-600 mb-2">
                      Formaliste – Service Registre du Commerce et des Sociétés
                    </h3>
                    ...
                    <h4 className="font-medium mb-4">
                      Greffe du Tribunal de Commerce, Évry
                    </h4>
                    <ul className="text-gray-700 space-y-2">
                      <li>
                        Vérification et traitement de plus de 600 dossiers par
                        mois
                      </li>
                      <li>
                        Saisie et suivi des formalités (immatriculations,
                        modifications, dissolutions, radiations)
                      </li>
                      <li>
                        Interface avec les organismes administratifs et
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <h4 className="font-medium mb-4">
                      Cabinet LYSIAS Partners, Paris
                    </h4>
                    <ul className="text-gray-700 space-y-2">
                      <li>
                        Préparation de dossiers pour les audiences et rédaction
                        d'actes
                      </li>
                      <li>
                        Gestion administrative (suivi des échéances,
                        correspondance, gestion de l'agenda juridique)
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <h4 className="font-medium mb-4">
                      Cabinet d'Avocats Bennouna et Menzel, Paris
                    </h4>
                    <ul className="text-gray-700 space-y-2">
                      <li>
                        Rédaction d'actes juridiques et préparation de dossiers
                        de plaidoirie
                      </li>
                      <li>
                        Gestion de l'agenda des avocats et suivi des procédures
                        légales
                      </li>
                    </ul>
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              Je vous accompagne dans toutes les étapes de la vie juridique de
              votre entreprise, de sa création à sa dissolution, en passant par
            ...
            <div className="bg-gray-50 rounded-lg p-8 shadow-md transition-transform duration-300 hover:transform hover:scale-105">
              ...
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-start">
                  ...
                  />
                  <span>
                    Immatriculation de sociétés commerciales (SARL, SAS, SA,
                    SNC)
                  </span>
                </li>
                <li className="flex items-start">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Vérification des formalités légales (RCS)",
          ...
          <div className="max-w-4xl mx-auto bg-gray-50 rounded-lg shadow-md overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 flex justify-center items-center">
                {" "}
                {/* Ajoutez items-center */}
                <div className="relative">
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-amber-200 flex justify-center items-center">
                    {" "}
                    {/* Ajoutez flex, justify-center et items-center */}
                    <img
                      src="https://github.com/youcefKNL/monia/blob/main/public/profile-pic.png?raw=true"
                      alt="Monia - Formaliste Senior"
                      className="w-full h-full object-cover"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="text-2xl font-bold mb-2">
                <span className="text-white">Monia</span>
                <span className="text-amber-400">Ammar</span>
              </div>
              <p className="text-gray-400">Juriste | Formaliste Senior</p>
            </div>

            <div className="flex space-x-6 mb-6 md:mb-0">
              <a
                href="https://www.linkedin.com/in/moniaa" // Remplacez par votre URL LinkedIn
              ...
              <a
                ...
                className="text-gray-400 hover:text-amber-400 transition-colors duration-300"
              >
                <User size={24} /> {/* Icône de profil utilisateur */}
              </a>

              <a
                href="mailto:mou_nia_4@hotmail.fr" // Remplacez par votre adresse e-mail
                className="text-gray-400 hover:text-amber-400 transition-colors duration-300"
              >
                <Mail size={24} />
              </a>
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm">
                © 2025 Monia Ammar. Tous droits réservés.
              </p>
              <div className="mt-2">
                <a
                  href="#"
                  className="text-gray-400 hover:text-amber-400 text-sm mr-4 transition-colors duration-300"
                >
                  Mentions légales
                </a>
                <a
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 bg-amber-600 text-white p-3 rounded-full shadow-lg transition-opacity duration-300 ${
